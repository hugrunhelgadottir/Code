...
module double_digit_screen(
   ...
   wire [2:0] dd_1_first;
   wire [2:0] dd_1_second;
   wire [2:0] dd_2_first;
   wire [2:0] dd_2_second;
   
    LFSR RNG (.clock(CLK), .reset(RST_BTN), .generate_input(generate_input), .random_num({dd_1_first, dd_1_second, dd_2_first, dd_2_second}));
    
    wire [9:0] a1_x_size = 30;
    wire [9:0] a1_y_size = 10;
    wire [9:0] a1_x_start = 120;
    wire [9:0] a2_x_start = 320;
    wire [9:0] a3_x_start = 50;
    wire [9:0] a4_x_start = 250;
    wire [8:0] a1_y_start = 225;
    wire [9:0] a1_x_offset = x - a1_x_start;
    wire [9:0] a2_x_offset = x - a2_x_start;
    wire [9:0] a3_x_offset = x - a3_x_start;
    wire [9:0] a4_x_offset = x - a4_x_start;
    wire [9:0] a1_y_offset = y - a1_y_start;
    wire [9:0] b1_x_size = 10;
    wire [9:0] b1_y_size = 30;
    wire [9:0] b1_x_start = 150;
    wire [9:0] b2_x_start = 350;
    wire [9:0] b3_x_start = 80;
    wire [9:0] b4_x_start = 280;
    wire [8:0] b1_y_start = 235;
    wire [9:0] b1_x_offset = x - b1_x_start;
    wire [9:0] b2_x_offset = x - b2_x_start;
    wire [9:0] b3_x_offset = x - b3_x_start;
    wire [9:0] b4_x_offset = x - b4_x_start;
    wire [9:0] b1_y_offset = y - b1_y_start;
    wire [9:0] g1_x_size = 30;
    wire [9:0] g1_y_size = 10;
    wire [9:0] g1_x_start = 120;
    wire [9:0] g2_x_start = 320;
    wire [9:0] g3_x_start = 50;
    wire [9:0] g4_x_start = 250;
    wire [8:0] g1_y_start = 265;
    wire [9:0] g1_x_offset = x - g1_x_start;
    wire [9:0] g2_x_offset = x - g2_x_start;
    wire [9:0] g3_x_offset = x - g3_x_start;
    wire [9:0] g4_x_offset = x - g4_x_start;
    wire [9:0] g1_y_offset = y - g1_y_start;
    wire [9:0] e1_x_size = 10;
    wire [9:0] e1_y_size = 30;
    wire [9:0] e1_x_start = 110;
    wire [9:0] e2_x_start = 310;
    wire [9:0] e3_x_start = 40;
    wire [9:0] e4_x_start = 240;
    wire [8:0] e1_y_start = 275;
    wire [9:0] e1_x_offset = x - e1_x_start;
    wire [9:0] e2_x_offset = x - e2_x_start;
    wire [9:0] e3_x_offset = x - e3_x_start;
    wire [9:0] e4_x_offset = x - e4_x_start;
    wire [9:0] e1_y_offset = y - e1_y_start;
    wire [9:0] d1_x_size = 30;
    wire [9:0] d1_y_size = 10;
    wire [9:0] d1_x_start = 120;
    wire [9:0] d2_x_start = 320;
    wire [9:0] d3_x_start = 50;
    wire [9:0] d4_x_start = 250;
    wire [8:0] d1_y_start = 305;
    wire [9:0] d1_x_offset = x - d1_x_start;
    wire [9:0] d2_x_offset = x - d2_x_start;
    wire [9:0] d3_x_offset = x - d3_x_start;
    wire [9:0] d4_x_offset = x - d4_x_start;
    wire [9:0] d1_y_offset = y - d1_y_start;
    wire [9:0] f1_x_size = 10;
    wire [9:0] f1_y_size = 30;
    wire [9:0] f1_x_start = 110;
    wire [9:0] f2_x_start = 310;
    wire [9:0] f3_x_start = 40;
    wire [9:0] f4_x_start = 240;
    wire [8:0] f1_y_start = 235;
    wire [9:0] f1_x_offset = x - f1_x_start;
    wire [9:0] f2_x_offset = x - f2_x_start;
    wire [9:0] f3_x_offset = x - f3_x_start;
    wire [9:0] f4_x_offset = x - f4_x_start;
    wire [9:0] f1_y_offset = y - f1_y_start;
    wire [9:0] c1_x_size = 10;
    wire [9:0] c1_y_size = 30;
    wire [9:0] c1_x_start = 150;
    wire [9:0] c2_x_start = 350;
    wire [9:0] c3_x_start = 80;
    wire [9:0] c4_x_start = 280;
    wire [8:0] c1_y_start = 275;
    wire [9:0] c1_x_offset = x - c1_x_start;
    wire [9:0] c2_x_offset = x - c2_x_start;
    wire [9:0] c3_x_offset = x - c3_x_start;
    wire [9:0] c4_x_offset = x - c4_x_start;
    ...
    case(dd_1_first)
    0: begin 
   if ((a3_x_offset >= 0 && a3_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | (b3_x_offset >= 0 && b3_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
    (e3_x_offset >= 0 && e3_x_offset < e1_x_size && e1_y_offset >= 0 && e1_y_offset < e1_y_size) | (d3_x_offset >= 0 && d3_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size) | (c3_x_offset >= 0 && c3_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
   (f3_x_offset >= 0 && f3_x_offset < f1_x_size && f1_y_offset >= 0 && f1_y_offset < f1_y_size))
   draw3 = 1'b1;
   else
   draw3 = 1'b0;
    end
        1: begin 
   if ((b3_x_offset >= 0 && b3_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
   (c3_x_offset >= 0 && c3_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size))
   draw3 = 1'b1;
   else
   draw3 = 1'b0;
    end
        2: begin 
   if ((a3_x_offset >= 0 && a3_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | (b3_x_offset >= 0 && b3_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
   (g3_x_offset >= 0 && g3_x_offset < g1_x_size && g1_y_offset >= 0 && g1_y_offset < g1_y_size) | (e3_x_offset >= 0 && e3_x_offset < e1_x_size && e1_y_offset >= 0 && e1_y_offset < e1_y_size) | 
   (d3_x_offset >= 0 && d3_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size))
   draw3 = 1'b1;
   else
   draw3 = 1'b0;
    end
        3: begin 
   if ((a3_x_offset >= 0 && a3_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | (b3_x_offset >= 0 && b3_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
   (g3_x_offset >= 0 && g3_x_offset < g1_x_size && g1_y_offset >= 0 && g1_y_offset < g1_y_size) |
   (d3_x_offset >= 0 && d3_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size) | 
   (c3_x_offset >= 0 && c3_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size))
   draw3 = 1'b1;
   else
...
(c3_x_offset >= 0 && c3_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
   ...
   draw3 = 1'b0;
        ...
        5: begin 
   if ((a3_x_offset >= 0 && a3_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | 
   (g3_x_offset >= 0 && g3_x_offset < g1_x_size && g1_y_offset >= 0 && g1_y_offset < g1_y_size) | 
   (d3_x_offset >= 0 && d3_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size) | (c3_x_offset >= 0 && c3_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
   (f3_x_offset >= 0 && f3_x_offset < f1_x_size && f1_y_offset >= 0 && f1_y_offset < f1_y_size))
   draw3 = 1'b1;
   else
   draw3 = 1'b0;
...
(c1_x_offset >= 0 && c1_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
 ...
 (c1_x_offset >= 0 && c1_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size))
   ...
   draw = 1'b0;
    ...
    case(dd_2_first)
    0: begin 
   if ((a4_x_offset >= 0 && a4_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | (b4_x_offset >= 0 && b4_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
    (e4_x_offset >= 0 && e4_x_offset < e1_x_size && e1_y_offset >= 0 && e1_y_offset < e1_y_size) | (d4_x_offset >= 0 && d4_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size) | (c4_x_offset >= 0 && c4_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
   (f4_x_offset >= 0 && f4_x_offset < f1_x_size && f1_y_offset >= 0 && f1_y_offset < f1_y_size))
   draw4 = 1'b1;
   else
   draw4 = 1'b0;
    end
        1: begin 
   if ((b4_x_offset >= 0 && b4_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
   (c4_x_offset >= 0 && c4_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size))
   draw4 = 1'b1;
   else
   draw4 = 1'b0;
    end
        2: begin 
   if ((a4_x_offset >= 0 && a4_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | (b4_x_offset >= 0 && b4_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
   (g4_x_offset >= 0 && g4_x_offset < g1_x_size && g1_y_offset >= 0 && g1_y_offset < g1_y_size) | (e4_x_offset >= 0 && e4_x_offset < e1_x_size && e1_y_offset >= 0 && e1_y_offset < e1_y_size) | 
   (d4_x_offset >= 0 && d4_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size))
   draw4 = 1'b1;
   else
   draw4 = 1'b0;
    end
        3: begin 
   if ((a4_x_offset >= 0 && a4_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | (b4_x_offset >= 0 && b4_x_offset < b1_x_size && b1_y_offset >= 0 && b1_y_offset < b1_y_size) | 
   (g4_x_offset >= 0 && g4_x_offset < g1_x_size && g1_y_offset >= 0 && g1_y_offset < g1_y_size) |
   (d4_x_offset >= 0 && d4_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size) | 
   (c4_x_offset >= 0 && c4_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size))
   draw4 = 1'b1;
   else
...
(c4_x_offset >= 0 && c4_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
   ...
   draw4 = 1'b0;
        ...
        5: begin 
   if ((a4_x_offset >= 0 && a4_x_offset < a1_x_size && a1_y_offset >= 0 && a1_y_offset < a1_y_size) | 
   (g4_x_offset >= 0 && g4_x_offset < g1_x_size && g1_y_offset >= 0 && g1_y_offset < g1_y_size) | 
   (d4_x_offset >= 0 && d4_x_offset < d1_x_size && d1_y_offset >= 0 && d1_y_offset < d1_y_size) | (c4_x_offset >= 0 && c4_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
   (f4_x_offset >= 0 && f4_x_offset < f1_x_size && f1_y_offset >= 0 && f1_y_offset < f1_y_size))
   draw4 = 1'b1;
   else
   draw4 = 1'b0;
...
(c2_x_offset >= 0 && c2_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size) |
 ...
 (c2_x_offset >= 0 && c2_x_offset < c1_x_size && c1_y_offset >= 0 && c1_y_offset < c1_y_size))
   ...
   reg [1:0] mode = 2'b00;
   reg sign;
   wire [9:0] mode_x_start = 190;
   wire [9:0] plus_x_start = 204;
   ...
   wire [9:0] offset_y = y - mode_y_start;
    ...
    always @ (*) begin
        if (draw | draw2 | draw3 | draw4 |ans_square | sign | equal) begin
            VGA_R = 4'b1111;
            VGA_G = 4'b1111;
            VGA_B = 4'b1111;
    end
